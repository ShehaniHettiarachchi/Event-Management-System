...
<title>Delete Attendee Page</title>
<!--styles-->
        ...
        <div class="col-6">
            <div class="row">
                <div class="col-10">
                    ...
                    <h1 class="text-center">Delete Attendee From The List</h1>
                </div>
            </div>  
                    ...
                    <form action="delete" method="post">
                        ...
                        <div class="form-row ml-5">
                            <div class="form-group">
                              ...
                              <input type="name" class="form-control" name="attname" id="inputname4" value="<%= attname %>" readonly>
                            </div>
                        </div>    
                        ...
                        <div class="form-row ml-5">
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" id="inputEmail4" value="<%= email %>" readonly>
                          </div>
                        </div>  
                        ...
                        <div class="form-row ml-5">
                            <div class="form-group">
                              ...
                              <input type="mobile" class="form-control" name="mobile" id="inputmobile4" value="<%= mobile %>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-row ml-5">
                            <div class="form-group ">
                                ...
                                <input type="nic" class="form-control" name="nic" id="inputnic4" value="<%= nic %>" readonly>
                            </div>
                          ...
                          <div class="form-group ml-5">
                            ...
                            <input type="affiliation" class="form-control" name="affillation" id="inputaff4" value="<%= affillation %>" readonly>
                          </div>
                        ...
                        <div class="text-center ml-5 mr-5">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg btn-block text-center">Delete Attendee</button>
