...
<title>Insert Attendee Form</title>
                    ...
                    <form action="InsertAttendeeServlet" method="post">
                        <div class="form-row ml-5">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="attname" id="inputname4" placeholder="Enter name">
                            </div>
                        </div>    
                        ...
                        <div class="form-row ml-5">
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="mobile" id="inputmobile4" placeholder="Enter mobile no">
                            </div>
                        </div>
                        ...
                        <div class="form-row ml-5">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="nic" id="inputnic4" placeholder="Enter NIC">
                            </div>
                          ...
                          <div class="form-group ml-5">
                            ...
                            <input type="text" class="form-control" name="affillation" id="inputaff4" placeholder="Enter Affiliation">
                          </div>
